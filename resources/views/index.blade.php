    ...
    <div class="col-span-3">
        <div class="text-left w-full md:w-auto font-bold mt-10 flex justify-between"><span>Barang
                Terbaru</span><span><a href=""
                    ...
                    Semua</a></span></div>
        <div
            class="mt-3 grid gap-5 p-5 md:p-0 grid-cols-1 md:grid-cols-4 lg:grid-cols-4 mn:grid-cols-1">

            <div class="h-96 w-full rounded-3xl shadow-lg overflow-hidden grid grid-cols-1">
                <div class="h-48 overflow-hidden">
                    <img class="object-cover h-full w-full" src="https://picsum.photos/600/400"
                        alt="">
                </div>
                <div class="bg-white p-3 h-48 relative">
                    ...
                    <button
                        class="absolute left-[50%] translate-x-[-50%] bottom-5 text-center rounded font-bold text-white bg-blue-400 w-10/12 p-2 hover:bg-blue-700 transition duration-500 drop-shadow-xl">Detail</button>
                </div>
            </div>
        </div>
    </div>
...
<div class="rounded w-full  grid grid-cols-1 md:grid-cols-3 gap-5 mt-5">
    <div class="rounded overflow-hidden relative shadow-lg">
        <img class="w-full h-52 object-cover" src="https://picsum.photos/1231/2123/?random=4"
            alt="">
        <div
    ...
    <div class="rounded overflow-hidden relative shadow-lg">
        <img class="w-full h-52 object-cover" src="https://picsum.photos/1231/2123/?random=5"
            alt="">
        <div
            class="bg-gradient-to-r from-yellow-500/40 to-transparent w-1/2 px-2 font-bold text-white absolute top-3 left-3 rounded">
            Contoh Gambar 1</div>
    ...
    <div class="rounded overflow-hidden relative shadow-lg">
        <img class="w-full h-52 object-cover" src="https://picsum.photos/1231/2123/?random=6"
            alt="">
        <div
            class="bg-gradient-to-r from-yellow-500/40 to-transparent w-1/2 px-2 font-bold text-white absolute top-3 left-3 rounded">
            Contoh Gambar 1</div>
