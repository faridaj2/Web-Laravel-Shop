...
<body>
    ...
    <nav class="shadow-xl bg-white">
        <div
            ...
            <span><a href="/">CARWASH TEKNIK</a></span>
    ...
    <div id="navTutup"
        ...
        <div class="w-1/2 h-full bg-white shadow-s1">
            <div class="text-[10px] text-center text-color1 p-3 shadow-sm"><b>CARWASH TEKNIK</b></div>
        ...
        <footer class=" px-2 text-center py-2 shadow-2xl md:flex justify-center gap-2 bg-stone-900 text-stone-300">
            ...
            <div class="md:text-left">
                ...
                <div class="text-[10px] font-medium">
                    <div>
                        <a href="" class="inline-block  mr-1"><svg xmlns="http://www.w3.org/2000/svg"
